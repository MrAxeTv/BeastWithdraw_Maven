...
final class WithdrawGuiOpenAnimationTask extends BukkitRunnable {
    ...
    private final WithdrawGuiAnimationSettings settings;
    ...
    WithdrawGuiOpenAnimationTask(BeastWithdrawPlugin plugin,
                                 Player player,
                                 BaseGui gui,
                                 int rows,
                                 Map<Integer, GuiItem> finalItems,
                                 WithdrawGuiAnimationSettings settings) {
        this.plugin = plugin;
        this.player = player;
        this.gui = gui;
    ...
    private boolean usesRowPause() {
        return settings.getType() == WithdrawGuiAnimationSettings.Type.SLIDE_LEFT_TO_RIGHT
                || settings.getType() == WithdrawGuiAnimationSettings.Type.SLIDE_RIGHT_TO_LEFT
                || settings.getType() == WithdrawGuiAnimationSettings.Type.SNAKE;
    }
