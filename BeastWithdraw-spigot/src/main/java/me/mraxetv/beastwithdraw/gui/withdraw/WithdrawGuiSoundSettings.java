...
final class WithdrawGuiSoundSettings {
    ...
    private WithdrawGuiSoundSettings(boolean enabled, Sound clickSound, Sound menuOpenSound,
    ...
    static WithdrawGuiSoundSettings from(BeastWithdrawPlugin plugin, WithdrawGuiProfile profile) {
        Sound defaultClick = resolveSound(plugin, "UI_BUTTON_CLICK", null, "withdraw-settings.yml Sounds.Click");
        Sound defaultOpen = resolveSound(plugin, "ENTITY_VILLAGER_TRADE", null, "withdraw-settings.yml Sounds.MenuOpen");
        return new WithdrawGuiSoundSettings(
                profile.getBoolean("Sounds.Enabled", true),
                resolveSound(plugin, profile.getString("Sounds.Click", "UI_BUTTON_CLICK"), defaultClick,
                        "withdraw-settings.yml Sounds.Click"),
                resolveSound(plugin, profile.getString("Sounds.MenuOpen", "ENTITY_VILLAGER_TRADE"), defaultOpen,
                        "withdraw-settings.yml Sounds.MenuOpen"),
