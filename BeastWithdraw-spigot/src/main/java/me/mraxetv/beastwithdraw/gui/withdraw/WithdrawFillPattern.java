...
final class WithdrawFillPattern {
    enum Type {
        ALL,
        BORDER,
        TOP,
    ...
    private WithdrawFillPattern(Type type, int fromRow, int fromColumn, int toRow, int toColumn) {
        this.type = type;
    ...
    static WithdrawFillPattern from(WithdrawGuiProfile profile, String basePath, int rows) {
        String patternPath = basePath + ".Pattern.";
        return new WithdrawFillPattern(
